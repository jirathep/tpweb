...
export default function EventListingPage() {
  ...
  useEffect(() => {
    ...
    setFilteredEvents(events);
  }, [searchTerm, selectedDate, selectedLocation, selectedEventType, allEvents]);
  ...
  return (
    <div className="space-y-8">
      <section className="bg-card p-6 rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold mb-6 text-center text-card-foreground">Find Your Next Experience</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
          <div className="space-y-1">
            <label htmlFor="search" className="text-sm font-medium text-muted-foreground">Search Event</label>
          ...
          <div className="space-y-1">
            ...
            <DatePicker date={selectedDate} setDate={setSelectedDate} buttonClassName="w-full bg-background text-foreground" />
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            <label htmlFor="eventType" className="text-sm font-medium text-muted-foreground">Event Type</label>
                ...
                <Link href={`/events/${event.id}`} className="block group">
                  ...
                  <CardHeader>
                    ...
                    <div className="flex items-center text-sm text-muted-foreground mt-1">
                      <CalendarIcon className="h-4 w-4 mr-1.5" /> {event.dates[0].date} at {event.dates[0].time}
                    </div>
