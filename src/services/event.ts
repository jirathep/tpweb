import type { Event, SeatingLayout, Zone, Seat, Location } from '@/lib/types';
...
const mockEvents: Event[] = [
  ...
  },
  {
    ...
    imageUrl: 'https://picsum.photos/seed/conference1/800/600',
  ...
  },
   {
    ...
    eventType: 'Concert',
    imageUrl: 'https://picsum.photos/seed/concert2/800/600',
  ...
  },
  {
    ...
    description: 'Witness world-class tennis as top players battle for the Grand Slam title. An event традиции and excitement.',
...
const mockSeatingLayouts: SeatingLayout[] = [
  ...
  // Add more layouts for other events
];
